...
var version$1 = 'v0.7.2-09a92d7'; // eslint-disable-line
...
var ProductVariantModel = BaseModel.extend(Object.defineProperties({
  ...
  */
  checkoutUrl: function checkoutUrl() {
    ...
    var userId = document.getElementsByClassName('shopifyBuyBtnEntryNode')[0].getAttribute('data-userid');
    var userIdUrlParam = '&attributes[userid]=' + userId;
